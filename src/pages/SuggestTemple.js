...
//   const getGods = async () => {
//     try {
//       const response = await api.get("/api/v1/pujari/god/");
//       setGods(response.data.results);
//     } catch (err) {
...
//     try {
//       const response = await api.post("/api/v1/devotee/temple/image/", formData);
...
//     try {
//       const response = await api.post("/api/v1/devotee/temple/video/", formData);
...
//     } else if (!pincodeRegex.test(suggest.pincode)) {
...
//     if (!panditName) errors.panditName = "Pandit name is required";
//     if (!panditNumber) {
//       errors.panditNumber = "Pandit number is required";
//     } else if (!phoneRegex.test(panditNumber)) {
//       errors.panditNumber = "Invalid phone number";
//     }
...
//     try {
//       await api.post("/api/v1/devotee/temple/create/", payload);
//       setAlert(true);
//       setSuggest({
//         name_en: "",
//         details_en: "",
...
//     } catch (err) {
//       console.error("Temple submit failed:", err);
//     }
//   };

//   return (
//     <main className="suggest-temple-main">
//       <div className="container">
//         <div className="card-custom">
//           <h2 className="form-title">Suggest a Temple</h2>

//           {alert && <div className="success-msg">Temple suggested successfully!</div>}

//           {[
//             "name_en", "details_en", "taluk_en", "district_en",
//             "area_en", "city_en", "state_en", "pincode", "address"
//           ].map((field) => (
//             <div className="form-group" key={field}>
//               <label>{field.replace("_en", "").toUpperCase()}*</label>
//               <input
//                 type={field === "pincode" ? "number" : "text"}
//                 className={`input ${error[field] ? "invalid" : ""}`}
//                 value={suggest[field]}
...
//             <input
//               type="text"
//               className={`input ${error.panditName ? "invalid" : ""}`}
//               value={panditName}
...
//             <input
//               type="number"
//               className={`input ${error.panditNumber ? "invalid" : ""}`}
//               value={panditNumber}
...
//             <input
//               type="text"
//               className={`input ${error.imagetitle ? "invalid" : ""}`}
//               value={imageTitle}
...
//             <input
//               type="text"
//               className={`input ${error.videotitle ? "invalid" : ""}`}
//               value={videoTitle}
...
//             {previewVideo && (
//               <video className="preview-video" controls src={previewVideo}></video>
//             )}
//           </div>
...
//         setGods(response.data.results);
//       } else {
//         console.warn("No gods found in response");
//       }
//     } catch (err) {
...
//     try {
//       const response = await api.post("devotee/temple/image/", formData);
//       setImageId(response.data.id);
//     } catch (error) {
//       console.error("Image upload failed:", error);
//     }
...
//     try {
//       const response = await api.post("devotee/temple/video/", formData);
//       setVideoId(response.data.id);
//       const reader = new FileReader();
//       reader.onload = () => {
...
//             <h5>Suggest a Temple</h5>
//           </div>

//           {alert && (
//             <div className="alert-custom">
//               ✅ Temple suggested successfully!
//             </div>
//           )}

//           <div className="card-body-custom">
//             {["name_en", "details_en", "taluk_en", "district_en", "area_en", "city_en", "state_en", "pincode", "address"].map((field) => (
//               <div className="form-group-custom" key={field}>
//                 <label>{field.replace("_en", "").toUpperCase()}*</label>
//                 <input
//                   type={field === "pincode" ? "number" : "text"}
//                   className={`input-custom ${error[field] ? "input-invalid" : ""}`}
//                   value={suggest[field]}
//                   onChange={(e) => setSuggest({ ...suggest, [field]: e.target.value })}
//                 />
//                 {error[field] && <div className="error-text">{error[field]}</div>}
//               </div>
//             ))}
...
//               <input
//                 type="text"
//                 className={`input-custom ${error.panditName ? "input-invalid" : ""}`}
//                 value={panditName}
//                 onChange={(e) => setPanditName(e.target.value)}
//               />
//               {error.panditName && <div className="error-text">{error.panditName}</div>}
//             </div>
...
//               <input
//                 type="number"
//                 className={`input-custom ${error.panditNumber ? "input-invalid" : ""}`}
//                 value={panditNumber}
//                 onChange={(e) => setPanditNumber(e.target.value)}
//               />
//               {error.panditNumber && <div className="error-text">{error.panditNumber}</div>}
//             </div>
...
//             {/* Image and video fields omitted for brevity */}
//             {/* ... */}
