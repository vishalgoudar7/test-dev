...
//   const imageUrl =
//     puja.image ||
//     (puja.images && puja.images.length > 0 && puja.images[0].image) ||
...
//       <div className="puja-nav-tabs">
//         <button className="tab active">About Puja</button>
//         <button className="tab">Benefits</button>
//         <button className="tab">Temple Details</button>
